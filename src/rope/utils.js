...
export const getRopeAddress = (rope) => {
    return rope && rope.ropeAddress;
}

export const getRopeMakerAddress = (rope) => {
    return rope && rope.ropeMaker;
}

export const getRopeContract = (rope) => {
    return rope && rope.contracts && rope.contracts.rope;
}
export const getRopeMakerContract = (rope) => {
    return rope && rope.contracts && rope.contracts.ropeMaker;
}
